...
final class BDD_UTILS {
	...
	public function enqueue_styles(){
		...
		wp_enqueue_style( 'bdd-slick-library', BDD_URL . '/assets/vendors/slick/slick.css', array(), '1.0.0', 'all' );
		wp_enqueue_style( 'bdd-slick-theme', BDD_URL . '/assets/vendors/slick/slick-theme.css', array('bdd-slick-library'), '1.0.0', 'all' );
		wp_enqueue_style( 'wpce-style', BDD_URL . '/assets/css/style.css', array('bdd-slick-library','bdd-slick-theme'), '1.0.0', 'all' );
	}
	...
	public function admin_scripts_styles(){
		...
		wp_enqueue_style( 'bdd-nt-admin-style', BDD_URL . 'admin/assets/css/admin.css', array(), '1.0.0', 'all' );
		
		wp_enqueue_script( 'bdd-nt-admin-script', BDD_URL . 'admin/assets/js/admin.js', array('jquery'), '1.0.0', 'all' );

		wp_localize_script( 'bdd-nt-admin-script', 'bdd_ajax_object',
            array(
	...
	public function enqueue_scripts(){
		wp_enqueue_script( 'bdd-slick-library', BDD_URL . 'assets/vendors/slick/slick.min.js', array( 'jquery' ), '1.0.0', true );
		wp_enqueue_script( 'bdd-main', BDD_URL . 'assets/js/main.js', array( 'bdd-slick-library' ), '1.0.0', true );
