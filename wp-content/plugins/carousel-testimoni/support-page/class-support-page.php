 ...
 *******************************/
add_action('wp_head', 'bdd_support_form_ajax_header');

if( !function_exists('bdd_support_form_ajax_header') )
{
	function bdd_support_form_ajax_header() 
	{
	...
	} //End of bdd_support_form_ajax_header
 ...
 *******************************/
add_action( 'wp_ajax_process_bdd_promo_form', 'process_bdd_promo_form' );

if( !function_exists('process_bdd_promo_form') )
{
	function process_bdd_promo_form()
	{
...
if( !class_exists('WPCE_SupportPage') ){
	...
	class WPCE_SupportPage{
		...
		function __construct( $plugin_slug = null )
		{
			...
			//add_action( 'wp_ajax_process_bdd_promo_form', array(&$this,'process_bdd_promo_form') );
